...
D2 Asking quality & honesty — an ask is OPTIONAL; judge whether any ask present is GENUINE and honestly framed. A genuine ask is: an open technical problem ${name} has NOT solved, OR a request for people to try/use/give feedback on what he shipped, OR an honest opinion-on-patterns question (he made a working choice and wants to hear how others approach it), OR whether anyone has explored a similar idea. The DISQUALIFIER is dishonest framing: re-asking something he ALREADY fully solved as if it were an open blocker, or inventing a struggle to justify a question. 3 = a genuine, honestly-framed ask (including a usage/pattern/idea invitation), OR no ask at all because nothing genuine fit (correct restraint — do NOT penalize the absence of an ask); 2 = a real ask but slightly soft or padded; 1 = a solved problem dressed up as an open blocker, or an ask manufactured from a routine decision; 0 = vague openness ("open to collaboration", "let me know").
